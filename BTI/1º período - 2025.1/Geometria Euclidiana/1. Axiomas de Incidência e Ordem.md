...
Dados três pontos não colineares $A$, $B$ e $C$, queremos provar, por absurdo, que eles determinam uma única reta.

Para tanto, teremos a reta $r$ possuindo os pontos $A$, $B$ e $C$, contradizendo, então, o axioma que afirma que dados dois pontos distintos, há apenas uma reta que os contém. Logo, como temos três pontos distintos não colineares, segue que, pelo axioma citado, as retas que contém os segmentos $AB$, $BC$ e $CA$ determinam três retas distintas.
