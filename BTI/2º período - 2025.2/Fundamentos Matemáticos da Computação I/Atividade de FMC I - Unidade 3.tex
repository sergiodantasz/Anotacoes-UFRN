...
\begin{document}
	...
	Agora iremos demonstrar que $(s_n)_n$ converge. Para tanto, iremos mostrar que a sequência é limitada e monótona.
	
	\textbf{Parte 1: A sequência é limitada.}
	
	Esse caso é imediato, pois já demonstramos anteriormente que 2 é uma cota superior de $(s_n)_n$. Logo, fechamos a parte 1.
	...
	\begin{align*}
		\sqrt{2 + \sqrt{\sqrt{2}}} > \sqrt{2}
		&\implies 2 + \sqrt{\sqrt{2}} > 2 \\
		&\implies \sqrt{\sqrt{2}} > 0 \\
		&\implies \sqrt{2} > 0 \\
		&\implies 2 > 0
	\end{align*}
