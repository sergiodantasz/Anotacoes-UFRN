...
\begin{document}
	...
	A nossa hipótese indutiva afirma que 2 é cota superior de $s_n = \sqrt{2 + \sqrt{s_{n - 1}}}$. Vamos mostrar que 2 também é cota superior de $s_{n + 1}$.
	
	Se 2 é cota superior de $s_n$, então $2 \geq s_n$.
