...
\begin{document}
	...
	Testemos o comportamento quando aumentamos os expoentes. Vamos escolher um subconjunto de casos onde $p = q = r = n$. O termo geral fica
	\[
	x_n = \frac{1}{2^n} + \frac{1}{3^n} + \frac{1}{5^n}.
	\]
	Observe que quando calculamos o limite quando $n \to \infty$, teremos
	\[
