...
\begin{document}
	...
	Seja a sequência $(a_n)_n$ tal que $a_0 = 0$ e $a_{n + 1} = \frac{a_n}{2} + 3$. Suponha que $(a_n)_n$ converge, ou seja, $(\exists l)(\forall \epsilon > 0)(\exists N)(\forall n \geq N)[d(a_n,l) < \epsilon]$.
