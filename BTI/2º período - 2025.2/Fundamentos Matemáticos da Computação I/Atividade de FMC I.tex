...
\begin{document}
	...
	Suponha, por absurdo, que existe $r$ real tal que, para todo $z$ inteiro, $r > z$. Ou seja, assumimos que $\mathbb{Z}$ é limitado superiormente por $r$.
	...
	Podemos aplicar a Propriedade Arquimediana neste caso, com $x \coloneq 1$ e $y \coloneq r$. Dessa forma, existe um natural $n$ tal que $n \cdot 1 > r \implies n > r$.
\end{document}
