...
\begin{document}
	...
	Note o seguinte:
	\[
	x > 0 \implies -x < 0 \implies S - x < S
	\]
	Como $S - x < S$, concluímos que $S - x$ não é cota superior de $A$. Isso implica que existe um número $m$ tal que $S - x < mx < y$ (pela definição do conjunto).
\end{document}
