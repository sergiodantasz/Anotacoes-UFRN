...
\begin{document}
	...
	Definimos agora um raio $K$ que seja grande o suficiente para cobrir tanto a ``cabeça'' quanto a ``calda''. Tomemos $K = \max(M, 1)$.
	
	Para $n < N$, a distância $d(a_n,l) \leq M \leq K$. Para $n \geq N$, a distância $d(a_n,l) < 1 \leq K$.
