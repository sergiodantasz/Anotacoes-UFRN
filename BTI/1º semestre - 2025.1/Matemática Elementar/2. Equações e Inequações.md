...
Analisando a parábola da equação do numerador, teremos $x < -1$ ou $x > 1$. Como o denominador não pode ser igual a zero, então as suas raízes não entram no intervalo. Assim, pela parábola da equação do denominador, teremos $x < -\sqrt{3}$ ou $x > \sqrt{3}$.
