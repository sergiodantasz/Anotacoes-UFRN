...
Seja $y = x^2$. Para $x = \sqrt{2}$ e $x = -\sqrt{2}$, temos $y = 2$; para $x = 3$ e $x = -3$, temos $y = 9$.

Agora, podemos obter uma equação do segundo grau a partir das raízes utilizando as relações de Girard:
