...
Já que a inequação deve ser menor que zero, então consideraremos apenas os valores de $x$ que satisfaçam tal. Pelo quadro de sinais, vamos ter $-5 < x \leq -3$ ou $-1 < x \leq 2$.
