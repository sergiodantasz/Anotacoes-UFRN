...
$$
\sqrt{\frac{p}{2} \cdot \left(\frac{p}{2} - a\right)\left(\frac{p}{2} - b\right)\left(\frac{p}{2} - c\right)} \leq \sqrt{\frac{p}{2} \cdot \left(\frac{\frac{p}{2} - a + \frac{p}{2} - b + \frac{p}{2} - c}{3}\right)^3} \implies
$$
